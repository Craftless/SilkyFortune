...
public class ModLootConditions {
    ...
    public static final RegistryObject<LootItemConditionType> BLOCK_TAG_LOOT_ITEM = LOOT_ITEM_CONDITIONS.register("blocktag", () -> new LootItemConditionType(BlockTagLootItemCondition.CODEC));
}
